#| My Choice Implementation with peek
Differences between this file and the original choice file are the functions
peek, stack, add-stack!, get-stack!, and get-stack!

(add-stack! '(-< <expr2> ...)) was added to the -< function to get a list of choices
|#
#lang racket
(provide -< peek next all clear ?-)
...
#|
(peek)
Gets unpopped choice points in the stack without popping
|#
(define (peek)
...
; "Push": add a choice to the stack stack.
(define (add-stack! choice)
  (set! stack
        (cons choice stack)))

; "Peek": return first stack from
; the stack stack.
(define (get-stack!)
  (first stack))
